        ...
        <div className="w-100">
            <Navbar className="sticky top-0 z-10 max-w-full rounded-none p-2 lg:p-4 mb-2 lg:mb-4">
                <div className="flex items-center justify-between text-blue-gray-900">
                    <Link to={'/'} className="flex items-center gap-4 cursor-pointer font-bold">
                        <img src="movie_clapperboard.svg" className="w-[12%]" alt="Filmia logo" />
                        <span className="text-3xl">FILMIA</span>
                    </Link>
